...
impl ResolveRunCount {
    ...
    pub fn encode<U0, U1>(
        ...
        input: ResolveRunCountInput<U0, U1>,
    ) -> CommandEncoder
    where
        U0: buffer::StorageBinding,
        U1: buffer::StorageBinding,
    {
        let ResolveRunCountInput {
            temporary_storage,
            run_count,
        } = input;
